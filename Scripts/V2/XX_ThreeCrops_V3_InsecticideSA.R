...
#                       "/Output/Figures/",
#                       "ThreeCrops_InsecticideSA_V3_YL_Plot.png"), 
#     width = 25,
#     height = 15,
#     units = "cm",
#     dpi = 500
...
#     filename = paste0(here(), 
#                       "/Output/Figures/",
#                       "ThreeCrops_InsecticideSA_V3_CLPH_Plot.png"), 
#     width = 25,
#     height = 15,
#     units = "cm",
#     dpi = 500
...
#   scale_x_continuous(
#     name = "Natural enemy presence as percentage.",
#     breaks = seq.int(from = 0, to = 1, by = 0.50),
#     labels  = seq.int(from = 0, to = 1, by = 0.50) %>%
#       sprintf("%.2f", .)
#   )  +
#   
